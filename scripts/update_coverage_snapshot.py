...
SUITE_NOTES: dict[str, str] = {
    ...
    "vanilla-gnome": "Baseline GNOME Shell parity check; runs on any GNOME image; includes an informational ShellVersion canary scenario (#826) that prints the running org.gnome.Shell ShellVersion to the run log and never gates the run",
