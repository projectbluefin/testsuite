...
| **OS under test (gnomeos)** | `gnomeos-latest` (≈ Fedora 44 / GNOME 50 — rolling to GNOME 51, GA 2026-09-16) | `quay.io/gnome_infrastructure/gnome-build-meta` |
...
The `vanilla-gnome` suite carries an informational `ShellVersion` canary
scenario (`@informational @version-canary`) that prints the running
