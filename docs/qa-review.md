...
The current branch's mechanical recount is 506 scenarios across 69 feature files:
394 active, 0 `@quarantine`, 112 `@future`/`@pending`/`@hardware_blocked`. The five active
