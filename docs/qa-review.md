...
The current branch's mechanical recount is 526 scenarios across 72 feature files:
413 active, 0 `@quarantine`, 113 `@future`/`@pending`/`@hardware_blocked` (see the generated snapshot in `docs/skills/test-authoring/suite-map/SKILL.md`). The five active
